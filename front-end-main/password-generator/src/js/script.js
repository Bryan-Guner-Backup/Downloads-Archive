...
function updateActualChars() {
    ...
    if(selection.numbers.checked)
        chars = chars.concat(selection.numbers.source)

    if(selection.symbols.checked)
        chars = chars.concat(selection.symbols.source)
...
function init() {
    const checkUpperCaseLetters = document.querySelector("#check-uppercase-letters");
    const checkLowerCaseLetters = document.querySelector("#check-lowercase-letters");
